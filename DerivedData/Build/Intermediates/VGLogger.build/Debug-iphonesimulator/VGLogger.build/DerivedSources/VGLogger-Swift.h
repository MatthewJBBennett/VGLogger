...
SWIFT_MODULE_NAMESPACE_PUSH("VGLogger")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC8VGLogger11AppDelegate")
...
SWIFT_CLASS("_TtC8VGLogger7BarCode")
@interface BarCode : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC8VGLogger17BarCodeDataSource")
@interface BarCodeDataSource : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC8VGLogger20BarCodeTableViewCell")
@interface BarCodeTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleCell;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified priceCell;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified merchantCell;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC8VGLogger26BarCodeTableViewController")
@interface BarCodeTableViewController : UITableViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC8VGLogger21BarCodeViewController")
...
SWIFT_CLASS("_TtC8VGLogger8Download")
...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified gameImage;
...
@interface FeedViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate, UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC8VGLogger26FilterSideBarTableViewCell")
@interface FilterSideBarTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified sideBarLabel;
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified sideBarSwitch;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC8VGLogger32FilterSideBarTableViewController")
@interface FilterSideBarTableViewController : UITableViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified ratingLabel;
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified ratingSwitch;
@property (nonatomic, weak) IBOutlet UISlider * _Null_unspecified ratingSlider;
- (void)viewDidLoad;
- (IBAction)ratingSwitched:(id _Nonnull)sender;
- (IBAction)ratingSlid:(id _Nonnull)sender;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)tableView:(UITableView * _Nonnull)tableView titleForHeaderInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC8VGLogger17NewsTableViewCell")
...
SWIFT_CLASS("_TtC8VGLogger25SearchTableViewController")
...
SWIFT_CLASS("_TtC8VGLogger19ThirdViewController")
...
SWIFT_CLASS("_TtC8VGLogger9VideoGame")
@interface VideoGame : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC8VGLogger19VideoGameDataSource")
@interface VideoGameDataSource : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified ratingLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified platformLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified esrbLabel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified addButton;
- (void)viewDidLoad;
- (void)addShare;
- (void)viewDidAppear:(BOOL)animated;
- (void)didReceiveMemoryWarning;
- (IBAction)didClickAddButton:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8VGLogger22VideoGameTableViewCell")
@interface VideoGameTableViewCell : UITableViewCell
...
SWIFT_CLASS("_TtC8VGLogger16WishlistDatabase")
@interface WishlistDatabase : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8VGLogger21WishlistTableViewCell")
@interface WishlistTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified gameTitleLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified gameCoverImage;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8VGLogger27WishlistTableViewController")
@interface WishlistTableViewController : UITableViewController
@property (nonatomic, strong) IBOutlet UITableView * _Null_unspecified wishlistView;
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
